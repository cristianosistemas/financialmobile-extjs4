...
class Database extends \MySQLi {
	...
	public function query($query) {
		...
		throw new \Exception("Erro ao execucar sql: $query");
	}
	...
	public function insert($table, $data) {
		...
		throw new \Exception("Erro ao execucar sql: $sql");
	}
	 ...
	 */
	public function select($table, $columns, $where = array(), $aditional = '', $limit = NULL, $offset = NULL) {
		if ($limit !== NULL) {
			$limit = (int) $limit;
		}
		if ($offset !== NULL) {
